...
:::{.figure}
![Years of Education over years](Graphs/years_edu_all.png){width=60%}
...
::: {#fig-combined layout="[[50,50]]"}
![Figure 2a](Graphs/change_enrollment6_12yo.png){width=90%} 

![Figure 2b](Graphs/change_enrollment13_17yo.png){width=90%}
...
:::{.figure}
![Correlation Dwellings and Years of Education](Graphs/corr_edu_dwelling.png){width=60%}

:::

Figure 3 shows the correlation between years of education and the average share of the population living in poor dwellings in rural areas, disaggregated by country.
:::
